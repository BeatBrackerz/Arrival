    ...
    return(
        <SafeAreaView className="flex-1 bg-white dark:bg-slate-800">
            <View>
                ...
                <Text className="text-center py-5 text-xl font-semibold text-black dark:text-white">Good Morning, Yannic</Text>
            ...
            <View className="flex-row bg-white justify-evenly py-2 mt-auto border-t border-gray-100 dark:bg-slate-800">
                ...
                >
                    <Icon name="car" type="font-awesome" color={colorScheme === 'light' ? 'white' : 'black'} size={16}/>
                    <Text className="text-white text-center dark:text-black">Vehicles</Text>
                </TouchableOpacity>

                <TouchableOpacity className="flex flex-row justify-around bg-black w-28 px-4 py-3 rounded-full dark:bg-white">
                    <Icon name="fast-food-outline" type="ionicon" color={colorScheme === 'light' ? 'white' : 'black'} size={16}/>
